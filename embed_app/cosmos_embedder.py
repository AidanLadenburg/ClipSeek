"""
Cosmos-Embed1 inference for ClipSeek search / embedder (copy for embed_app).
Model resolution: `embed_app/cosmos_model`, then sibling `extension/cosmos_model`, else Hugging Face hub.
"""
import os
import numpy as np
import torch
...
def resolve_cosmos_model_path():
    ...
    candidates = [
        ...
        os.path.join(parent, "extension", "cosmos_model"),
    ]
    for p in candidates:
