...
from .pos_embed import get_3d_sincos_pos_embed, interpolate_pos_embed_internvideo2#, get_2d_sincos_pos_embed, get_1d_sincos_pos_embed
...
class Block(nn.Module):
    ...
    def forward(self, x, residual=None):
        if self.with_cp:
            ...
            return checkpoint.checkpoint(self._inner_forward, x, residual)
        else:
