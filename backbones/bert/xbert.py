...
class BertEmbeddings(nn.Module):
    ...
    def forward(
        self,
        input_ids=None,
        target_word_id=None,  # ID of the target word to be replaced
        precomputed_encoding=None,  # Precomputed encoding tensor
        token_type_ids=None,
        position_ids=None,
        inputs_embeds=None,
        ...
        # ADD ABILITY TO DEFINE ANNOTATIONS
        special_token_id = 17662 
        import numpy as np

        #image_projection = nn.Linear(768, 1024)  #ADDED layer to project images to work with text
        #mask = input_ids == special_token_id
        #inputs_embeds[mask] = (precomputed_embedding).to(torch.device('cuda'))
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        #print("SELF ATTENTION", hidden_states.shape)
